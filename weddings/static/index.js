webpackJsonp([5], [function(e, t, i) {
    ...
    var E = {
        ...
        pageChangeCallback: function() {
            I["default"].pageChange(u["default"].currentPageIndex),
            u["default"].currentPageIndex === f["default"].getPageLength() - 1 && (h["default"].judgeShowAd() ? C["default"].loadStart() : A["default"].loadStart())
        }
    };
    u["default"].setOption(E),
    ...
    var a = function() {
      ...
      , l = function() {
        ...
        return a(e, [{
            ...
            key: "isWX",
            value: function() {
                if (window.Config.isAppNormalMode() && 4 == window.projectVersion.status)
                    return !1;
                var e = navigator.userAgent;
...
, function(e, t, i) {
    ...
    function c(e, t) {
        ...
        void (e._54 = [e._54, t])) : void e._54.push(t) : void u(e, t)
    }
    function u(e, t) {
        m(function() {
            var i = 1 === e._81 ? t.onFulfilled : t.onRejected;
            if (null === i)
                return void (1 === e._81 ? d(t.promise, e._65) : f(t.promise, e._65));
            var n = a(i, e._65);
    ...
    function d(e, t) {
        ...
        if (t && ("object" == typeof t || "function" == typeof t)) {
            ...
            if (i === w)
                return f(e, v);
            if (i === e.then && t instanceof s)
                return e._81 = 3,
                e._65 = t,
                void p(e);
            if ("function" == typeof i)
                return void g(i.bind(t), e)
        }
        e._81 = 1,
        e._65 = t,
        p(e)
...
, function(e, t, i) {
    ...
    function r(e, t) {
        d["default"].getJSON(window.Config.getWxKeyURL(), function(i) {
            200 === i.code && (e.wechat = i.data.wechat,
            t(e))
        })
    }
    function s(e) {
    ...
    function l(e) {
        ...
        r(e, function(e) {
            ...
            "undefined" != typeof DS && DS.ready(function() {
                if (e.link = DS.linkChange(i),
                n && (e.link = e.link + "&task_id=" + p["default"].getUrlParameter("task_id") + "&member_id=" + p["default"].getUrlParameter("member_id")),
                window.projectVersion.urlParam)
                    for (var t = 0; t < window.projectVersion.urlParam.length; t++)
                        -1 === e.link.indexOf(window.projectVersion.urlParam[t]) && (e.link += "&" + window.projectVersion.urlParam[t]);
    ...
    function c(e, t) {
        var i = (0,
        v["default"])({}, window.projectVersion, e)
          , n = i.link
        ...
        a(window.wx, i, !t),
        "undefined" != typeof DS && DS.ready(function() {
            if (i.link = DS.linkChange(n),
            o && (i.link = i.link + "&task_id=" + p["default"].getUrlParameter("task_id") + "&member_id=" + p["default"].getUrlParameter("member_id")),
            window.projectVersion.urlParam)
                for (var e = 0; e < window.projectVersion.urlParam.length; e++)
                    -1 === i.link.indexOf(window.projectVersion.urlParam[e]) && (i.link += "&" + window.projectVersion.urlParam[e]);
      ...
      , u = function() {
        ...
        return a(e, [{
            ...
            value: function() {
                var e = this;
                "undefined" != typeof DS && DS.ready(function() {
                    for (var t in e.waitingReq)
                        e.sendToDataStory(e.waitingReq[t])
                })
            }
        }, {
            key: "sendToDataStory",
 ...
 * Licensed under the MIT license */
    !function(o, a, r, s) {
        ...
        function c(e, t, i) {
            return Array.isArray(e) ? (u(e, i[t], i),
            !0) : !1
        }
        function u(e, t, i) {
            var n;
        ...
        function W(e, t) {
            var i = A(e.touches)
              , n = this.targetIds;
            if (t & (Ue | Me) && 1 === i.length)
                return n[i[0].identifier] = !0,
                [i, i];
            var o, a, r = A(e.changedTouches), s = [], l = this.target;
        ...
        function K(e, t) {
            e & Ue ? (this.primaryTouch = t.changedPointers[0].identifier,
            G.call(this, t)) : e & (ze | Be) && G.call(this, t)
        }
        function G(e) {
        ...
        var ge, me = ["", "webkit", "Moz", "MS", "ms", "o"], ve = a.createElement("div"), we = "function", be = Math.round, ye = Math.abs, ke = Date.now;
        ...
        f(L, E, {
            handler: function(e) {
                ...
                t & Me && 1 !== e.which && (t = ze),
                this.pressed && (t & ze && (this.pressed = !1),
        ...
        o.MSPointerEvent && !o.PointerEvent && ($e = "MSPointerDown",
        ...
        f(V, E, {
            handler: function(e) {
                ...
                o & Ue && (0 === e.button || r) ? 0 > s && (t.push(e),
                s = t.length - 1) : o & (ze | Be) && (i = !0),
                0 > s || (t[s] = e,
        ...
        ee.prototype = {
            ...
            dropRecognizeWith: function(e) {
                return c(e, "dropRecognizeWith", this) ? this : (e = ne(e, this),
            ...
            canEmit: function() {
                for (var e = 0; e < this.requireFail.length; ) {
                    if (!(this.requireFail[e].state & (xt | vt)))
                        return !1;
                    e++
                }
                return !0
            ...
            recognize: function(e) {
                var t = ge({}, e);
                return h(this.options.enable, [this, t]) ? (this.state & (kt | At | xt) && (this.state = vt),
                this.state = this.process(t),
                void (this.state & (wt | bt | yt | At) && this.tryEmit(t))) : (this.reset(),
                void (this.state = xt))
            },
            process: function(e) {},
        ...
        f(ae, oe, {
            ...
            directionTest: function(e) {
                var t = this.options
                  ...
                  , a = e.deltaX
                  , r = e.deltaY;
                return o & t.direction || (t.direction & qe ? (o = 0 === a ? Ne : 0 > a ? Fe : He,
                i = a != this.pX,
                n = Math.abs(e.deltaX)) : (o = 0 === r ? Ne : 0 > r ? Le : Ve,
                i = r != this.pY,
                n = Math.abs(e.deltaY))),
                e.direction = o,
        ...
        f(se, ee, {
            ...
            emit: function(e) {
                this.state === kt && (e && e.eventType & ze ? this.manager.emit(this.options.event + "up", e) : (this._input.timeStamp = ke(),
        ...
        f(ue, ee, {
            ...
            emit: function() {
                this.state == kt && (this._input.tapCount = this.count,
                this.manager.emit(this.options.event, this._input))
            }
        }),
        de.VERSION = "2.0.7",
    ...
    var a = function() {
      ...
      , m = function() {
        ...
        return a(e, [{
            ...
            value: function() {
                var e = this;
                if (console.log("captrue init" + window.Config.getContentJSONUrl()),
                p["default"].isADtrans()) {
                    var t = c["default"].getCookie("openid")
                      , i = c["default"].getUrlParameter("sign");
                    if (void 0 === t || void 0 === i)
                        return void (location.href = Config.getADtransLoginUrl(location.href));
                ...
                return new d["default"](function(t, i) {
                    ...
                    s["default"].ajax({
                        ...
                        success: function(i) {
                            ...
                            e.music = i.data.pdata.music,
                            e.menu = i.data.pdata.menu,
                            p["default"].isExam(e.contentJSON) && p["default"].isWX()) {
                                if (void 0 === c["default"].getCookie(window.Config.wxCookie))
                                    return void (location.href = Config.getLoginUrl());
                            ...
                            if (e.contentJSON = (0,
                            g["default"])(e.contentJSON),
                            p["default"].needWxLogin && p["default"].isWX()) {
                                if (void 0 === c["default"].getCookie(window.Config.wxCookie))
                                    return void (location.href = Config.getLoginUrl(p["default"].hasVote));
                                if (p["default"].hasVote)
                                    return void e.advancedVoteApi().then(function(i) {
        ...
        var r = function(e, t, i) {
            ...
            if (void 0 !== n.length) {
                for (var o = {
                    ...
                    "string" == typeof t ? o.chainers.push(l(n[a], t, s(i, a, r))) : o.chainers.push(l(n[a], s(t, a, r), i));
                return o
            }
          ...
          , s = function(e, t, i) {
            ...
            Q(e.callback) && (console.log("DeprecationWarning: callback is renamed to complete"),
            n.complete = function() {
          ...
          , l = function(e, i, n) {
            function o(i) {
                return v.tick(i),
                v.updateElement(e),
                v.isStopped() ? void 0 : v.completed() ? void (a.loop > 1 && !v.isStopped() ? (a.loop -= 1,
                v.restart(),
                w(o)) : (a.complete && a.complete.call(e),
                b.length && (a = b.pop(),
                l = g(a, d, !0),
                d = g(a, W(d)),
                a = m(l, d, a),
          ...
          , c = function(e, i) {
            function n(t) {
                a.tick(t),
                a.updateElement(e),
                a.completed() ? (i.callback && i.callback(e),
                i.loop && i.loop > 1 && (i.loop--,
                a.restart(),
                w(n))) : w(n)
            }
            var o = g(i, F({}));
          ...
          , y = function(e) {
            ...
            return c = e.valueFeeder ? L(e.valueFeeder, t, i, s) : H(t, i, s),
            {
                ...
                tick: function(t) {
                    if (f)
                        return void (v || (e.selfFinish && e.selfFinish(),
                        l && l(),
                        v = !0));
                    if (h)
                        return d = t,
                    ...
                    if (u || (u = t),
                    t - u > o) {
                        !p && e.startCallback && e.startCallback(),
                        p = !0,
                        d = t - o;
                        var i = Math.min(Math.max(0, d - u), n);
                        r.tick(i / n),
                        this.updateCurrentTransform(),
                        this.completed() && !v && (e.selfFinish && e.selfFinish(),
                        l && l(),
                        v = !0)
                    }
                },
          ...
          , k = function(e) {
            ...
            return {
                ...
                tick: function(e) {
                    n || i.equilibrium || (i.tick(),
                    this.updateMovement())
                },
                updateMovement: function() {
                    var e = i.getValue();
                    o && (u.position[0] = t.position[0] * e,
                    u.position[1] = t.position[1] * e,
                    u.position[2] = t.position[2] * e),
                    a && (u.rotation[0] = t.rotation[0] * e,
                    u.rotation[1] = t.rotation[1] * e,
                    u.rotation[2] = t.rotation[2] * e),
                    r && (u.rotationPost[0] = t.rotationPost[0] * e,
                    u.rotationPost[1] = t.rotationPost[1] * e,
                    u.rotationPost[2] = t.rotationPost[2] * e),
                    s && (u.scale[0] = 1 + t.scale[0] * e,
                    u.scale[1] = 1 + t.scale[1] * e),
                    l && (u.scalePost[0] = 1 + t.scalePost[0] * e,
                    u.scalePost[1] = 1 + t.scalePost[1] * e),
                    c && (u.skew[0] = t.skew[0] * e,
                    u.skew[1] = t.skew[1] * e)
                },
          ...
          , B = function() {
            ...
            return M(e),
            {
                data: e,
                asCSS: function() {
                    for (var t = "matrix3d(", i = 0; 15 > i; ++i)
                        t += Math.abs(e[i]) < 1e-4 ? "0," : e[i].toFixed(10) + ",";
          ...
          , F = function K(e) {
            ...
            return {
                ...
                asMatrix: function() {
                    ...
                    this.rotation && (e.rotateX(this.rotation[0]),
                    e.rotateY(this.rotation[1]),
                    e.rotateZ(this.rotation[2])),
                    this.position && e.translate(this.position[0], this.position[1], this.position[2]),
                    this.rotationPost && (e.rotateX(this.rotationPost[0]),
                    e.rotateY(this.rotationPost[1]),
                    e.rotateZ(this.rotationPost[2])),
            ...
            return {
                tween: function(e) {
                    ...
                    if (u) {
                        ...
                        a.scalePost[1] = n.scalePost[1] + e * E
                    }
                    if (f) {
    ...
    i(12))
      ...
      , p = function() {
        ...
        return a(e, [{
            ...
            value: function() {
                this.wrapperElm = (0,
                s["default"])('<div class="chart-wrapper"></div>'),
                this.wrapperElm.css({
                    position: "absolute",
            ...
            value: function() {
                return this.swipeImgElm = (0,
                s["default"])('<img src="' + window.Config.getImgOss("images/swiper/swipewarn.png") + '"></img>'),
    ...
    (function(t) {
        ...
        function n() {
            for (; c < s.length; ) {
                ...
                s[e].call(),
                c > u) {
                    for (var t = 0, i = s.length - c; i > t; t++)
                        s[t] = s[t + c];
                    s.length -= c,
                    c = 0
                }
    ...
    var n = function() {
      ...
      , o = function() {
        ...
        return n(e, [{
            ...
            value: function(e) {
                var t = {};
                return e.animationVersion && 1 === e.animationVersion || e.elementAnimations && e.elementAnimations.animation_in && e.elementAnimations.animation_in.show ? (t.show = e.elementAnimations.animation_in.show,
                t.delay = e.elementAnimations.animation_in.delay,
                t.delay > 0 && t.delay < 10 && (t.delay = 1e3 * t.delay),
                t.speed = e.elementAnimations.animation_in.speed,
                t.speed > 0 && t.speed < 10 && (t.speed = 1e3 * t.speed)) : (t.show = e.show,
                t.delay = e.delay,
                t.speed = e.speed),
      ...
      , k = function() {
        ...
        return a(e, [{
            ...
            value: function(e) {
                ...
                if (g["default"].send("pageLoadStart", e.index),
                e.bgpic && "0" !== e.bgpic && " " !== e.bgpic)
                    try {
                        var a = void 0
                          , r = {};
                        ...
                        else if (e.bgpic.indexOf("test.img.maka.im") > 0 || e.bgpic.indexOf("test.img1.maka.im") > 0)
                            a = e.bgpic;
                        else if (e.bgpic.indexOf("img2") > 0 || e.bgpic.indexOf("img1") > 0)
                            a = e.bgpic;
                        else if (-1 === e.bgpic.indexOf("user/") && e.bgpic.indexOf("img1.maka.im") > -1)
                            a = e.bgpic;
                        else {
                ...
                if (e.content.map(function(o) {
                    ...
                    case "pshape":
                        ...
                        if ("0" === o.shape && (o.shape = "1.svg"),
                        o.shape.indexOf("<svg") >= 0) {
                            o.svgXml = (0,
                            s["default"])(o.shape);
                            break
                        }
                    ...
                    case "phone_call":
                        ...
                        k = k.then(function(e) {
                            return o.phoneInfoDom = (0,
                            s["default"])(e),
                            e
                        }),
                        A = A.then(function(e) {
                            return o.phoneRemindDom = (0,
                            s["default"])(e),
                            e
                        }),
                        x = x.then(function(e) {
                            return o.phonecallDom = (0,
                            s["default"])(e),
                            e
                        }),
                        n.push(w),
                    ...
                    case "ptext":
                        ...
                        if (o.fontId && o.fontId.indexOf("makaOSS") > -1 && o.fontUrl) {
                            ...
                            if (!y.loadEnd[O]) {
                                y.loadEnd[O] = !0;
                                for (var U = [".bmp"], M = void 0, z = 0; z < U.length; z += 1)
                                    M = O + U[z],
                                    R(M)
                            }
                            break
                        ...
                        if (o.fontId && o.fontUrl) {
                            var B, N = (o.fontId,
                            !1);
                            if (o.fontId.indexOf("makafont_") >= 0)
                                B = window.Config.engFontUrl + o.fontId + ".ttf";
                            else if (o.fontUrl && o.fontUrl.indexOf("youziku_") > -1) {
                                if (B = o.fontUrl.replace("youziku_", ""),
                                "_font_default" == o.fontTag)
                                    break;
                                B.match(/http/g).length >= 1 && -1 != B.indexOf("font-face") ? N = !0 : B = B.replace("') format('woff')", "")
                            } else
                                o.fontUrl && (B = o.fontUrl);
                            if (!y.loadEnd[B])
                                if (y.loadEnd[B] = !0,
                                N) {
                                    var F = B.split("url(");
                                    F.length;
                                    (0,
                                    v["default"])(B.substring(0, B.lastIndexOf("}", B.length - 2) + 1))
                                } else {
                    ...
                    case "puzzle":
                        ...
                        o.urls.length && (o.urlDom = [],
                        o.urls.map(function(t) {
                            var i = window.Config.getImgUrl(t)
                              , a = y.loadImage(i, o, e);
                            a = a.then(function(e) {
                                return o.urlDom.push((0,
                                s["default"])(e)),
                                e
                            }),
                            n.push(a)
                    ...
                    case "relay":
                        if (!o.ownInfo) {
                            ...
                            q = q.then(function(e) {
                                return e && 200 == e.code && (o.canRealy = e.data.can_relay,
                                o.relayed = e.data.already_relay,
                                o.rank = e.data.rank,
                                o.ownInfo = e.data.own_info.ercode ? void 0 : e.data.own_info,
                                o.picSrc = e.data.participators_info || []),
                                e
                            }),
                            n.push(q)
                        }
                    ...
                    case "map":
                        ...
                        if (Y) {
                            ...
                            var K = new c["default"](function(e) {
                                ...
                                window[i] = function() {
                                    for (var e = 0; e < window.mapAllPromise.length; e++)
                                        window.mapAllPromise[e]();
            ...
            value: function(e, t, i) {
                return new c["default"](function(n) {
                    ...
                    if (o.onload = function() {
                        a || (d["default"].log("Load image succeeded..." + e),
                        a = !0,
                        n(o))
                    }
                    ,
                    o.onerror = function(t) {
                        ...
                        a || (d["default"].log("Load image failed " + e + t),
                        a = !0,
                        n(o))
                    }
                    ,
                    window.Config.isTurnOffOssCrop())
                        o.src = e;
                    else {
                        var r = /\.jpg|\.jpeg/i
                          , s = r.exec(e);
                    ...
                    0 !== i.index && window.Config.isAppNormalMode() && "pEraser" !== t.type && (a || (a = !0,
                    n(o)))
                }
                )
            }
            ...
            value: function(e) {
                return new c["default"](function(t) {
                    y.loadEnd[e] ? t(y.loadEnd[e]) : y.loading[e] ? (console.log("load wait"),
                    y.loadingWait[e].push(t)) : (y.loading[e] = !0,
                    y.loadingWait[e] = [],
                    y.loadingWait[e].push(t),
    ...
    var Ie = null
      , Ee = function() {
        function e() {
            ...
            this.hasPhoneCallEffect = !1,
            this.hasPhoneSoundEffect = !1,
            window.Config.isAppNormalMode() && (this.audioEffect = new Audio,
            ge["default"].setEffectMusic(this.audioEffect)),
            this.pageZLevel = {
                top: 999,
                bottom: 0,
                music: 1e3
        ...
        return a(e, [{
            ...
            value: function() {
                ...
                for (var i in d["default"].contentJSON) {
                    ...
                    for (var o in n)
                        "phone_call" === n[o].type ? e = !0 : "phoneSound" === n[o].type && (t = !0)
                }
                return {
            ...
            value: function() {
                ...
                s["default"])(".ADpage");
                (0,
                s["default"])(window).on("message", function(t) {
            ...
            value: function() {
                ...
                Ie.scaleRatio = l > r ? r : l,
                Ie.bgScaleRatio = r > l ? r : l,
                l > r ? (e = o > document.body.clientWidth ? document.body.clientWidth : o,
                t = e * (a / o),
                i = o < document.body.clientWidth ? (document.body.clientWidth - o) / 2 : 0,
                n = t < document.body.clientHeight ? (document.body.clientHeight - t) / 2 : 0) : (t = a > document.body.clientHeight ? document.body.clientHeight : a,
                e = t * (o / a),
                n = a < document.body.clientHeight ? (document.body.clientHeight - a) / 2 : 0,
            ...
            value: function(e) {
                ...
                return e = parseInt(Math.round(e * Ie.scaleRatio)),
                e + "px"
            }
        }, {
            key: "setCommonCSS",
            ...
            value: function() {
                if (window.Config.isAppNormalMode()) {
                    var e = d["default"].getMusic()
                      ...
                      , i = Ie.findPageEffect();
                    if (Ie.hasPhoneCallEffect = i.hasPhoneCallEffect,
                    Ie.hasPhoneSoundEffect = i.hasPhoneSoundEffect,
                    e) {
                        var n = (0,
                    ...
                    var o = function a() {
                        setTimeout(function() {
                            ...
                            Ie.audioBackground.paused || (0,
                            s["default"])("body").off("touchstart touchmove touchend", a),
                            void v["default"].log("Start play music for user......."))
                        })
                    };
                    (0,
                    s["default"])("body").on("touchstart touchmove touchend", o)
                }
            }
        }, {
            key: "initEffectMusic",
            ...
            value: function(e) {
                window.Config.isAppNormalMode() && (e === !0 ? Ie.isMusicOn = e : Ie.isMusicOn = !Ie.isMusicOn,
                Ie.musicDom && (Ie.isMusicOn ? (Ie.musicDom.attr({
                    src: x["default"]
                }),
                ...
                ge["default"].pauseBg(),
                M["default"].send("closeMusic")),
                Ie.audioBackground.paused && (Ie.isMusicOn = !1,
                Ie.musicDom && Ie.musicDom.attr({
                    src: k["default"]
                }))))
            }
        }, {
            ...
            value: function(e, t) {
                if (e && 0 !== e.length) {
                    ...
                    var i = []
                      , n = [];
                    Ie.firstEnsurePagesStarted || (Ie.preload.increaseSteps(1),
                    v["default"].runAsync(function() {
                    ...
                    Ie.firstEnsurePagesStarted = !0
                }
            }
        }, {
            key: "ensureAllPages",
            value: function(e) {
                for (var t = [], i = d["default"].getPageLength(), n = 0; i > n; n++)
                    t.push(n);
            ...
            value: function() {
                ...
                if (!xe["default"].isNeedStopAni(e.effect) || !window.pageEffectRuning) {
                    if (v["default"].log("Decide to show previous page, currentPageIndex:" + Ie.currentPageIndex),
                    Ie.currentPageIndex > 0) {
                        var t, i, n, o, a, r, l, c = function() {
                            ...
                            window.Config.isAppNormalMode()) {
                                ...
                                Ie.panDownAnimations || c.swipeDownLock || Ie.initpanDownAnimations(c),
                                a.show(),
                                Ie.animateToPrevPage(function() {
                                    var t = d["default"].getPage(e)
                                      , o = d["default"].getPage(n);
                                    i.hide(),
                                    a.show(),
                                    Ie.hidePageElement(t),
                                    Ie.showPageInAnimation(o),
                                    Ie.showAdarea(),
                                    Ie.showArrow(),
                                    setTimeout(function() {
                                ...
                                Ie.showPageInAnimation(l);
                            Ie.onPageChange(n, e),
                            Ie.currentPageIndex = n,
                            Ie.option.pageChangeCallback && Ie.option.pageChangeCallback()
                        }();
                        if ("object" == typeof c)
                            return c.v
            ...
            value: function(e) {
                e === Ie.currentPageIndex || e >= d["default"].getPageLength() || Ie.ensurePages([e], function() {
                    ...
                    a.fadeIn(function() {
                        ...
                        Ie.hidePageElement(o),
                        Ie.currentPageIndex = e,
                        Ie.option.pageChangeCallback && Ie.option.pageChangeCallback(),
                        Ie.showAdarea(),
                        Ie.showArrow(),
                        setTimeout(function() {
            ...
            value: function(e) {
                ...
                xe["default"].isNeedStopAni(t.effect) && window.pageEffectRuning || (v["default"].log("Decide to show next page, currentPageIndex:" + Ie.currentPageIndex),
                Ie.hasNextPage() ? !function() {
                    ...
                    Ie.ensurePages([n], function() {
                        ...
                        if (window.Config.isAppNormalMode()) {
                            ...
                            if (a.swipeUpLock)
                                return;
                            Ie.panUpAnimations || a.swipeUpLock || Ie.initpanUpAnimations(a),
                            t.show(),
                            Ie.animateToNextPage(function() {
                                var e = d["default"].getPage(i)
                                  , a = d["default"].getPage(n);
                                o.hide(),
                                t.show(),
                                Ie.hidePageElement(e),
                                Ie.showPageInAnimation(a),
                                Ie.showAdarea(),
                                Ie.showArrow(),
                                setTimeout(function() {
            ...
            value: function() {
                if (window.Config.isAppNormalMode()) {
                    var e = (0,
                    s["default"])(".maka-adArea")
                      , t = 100;
                    Ie.currentPageIndex === d["default"].getPageLength() - 1 ? (e.fadeIn(),
                    v["default"].log("show"),
                    "free_user" === window.projectVersion.viplevel && v["default"].parentPost({
                        type: "showAD"
                    }),
                    (0,
                    s["default"])(".maka-adArea").unbind(),
                    (0,
                    s["default"])(".maka-adArea").on("click", function() {
            ...
            value: function(e) {
                window.Config.isAppNormalMode() && e.content.forEach(function(e) {
                    Pe["default"].actAnimation(e),
                    e.showCallback && e.showCallback(),
                    "charts" === e.type && (e.chartElement.render(),
                    e.dom.fadeIn()),
            ...
            value: function(e) {
                ...
                var n = function(e) {
                    ...
                    Ie.preUp[t + "" + e] = Ie.panUpAnimations[e],
                    Ie.panUpAnimations[e].finish(function() {
                        delete Ie.preUp[t + "" + e],
                        i()
                    })
                };
                for (var o in Ie.panUpAnimations)
                    n(o);
                Ie.panUpAnimations = null,
                Ie.panDownAnimations = null
            }
            ...
            value: function(e) {
                ...
                var n = function(e) {
                    var t = Ie.currentPageIndex;
                    Ie.preDown[t + "" + e] = Ie.panDownAnimations[e],
                    Ie.panDownAnimations[e].finish(function() {
                        delete Ie.preDown[t + "" + e],
                        i()
                    })
                };
                for (var o in Ie.panDownAnimations)
                    n(o);
                Ie.panUpAnimations = null,
                Ie.panDownAnimations = null
            }
            ...
            value: function(e) {
                ...
                if (!xe["default"].isNeedStopAni(t.effect) || !window.pageEffectRuning) {
                    ...
                    if (!(0 == o.length && Ie.currentPageIndex < d["default"].getPageLength() - 1)) {
                        ...
                        if ((r || l) && (console.log(e.changedPointers[0].clientX + "x" + document.body.clientWidth + "y" + e.changedPointers[0].clientY),
                        this.hammerPages.stop(),
                        e.isFinal = !0),
                        e.isFinal)
                            if (0 > n)
                                if (Math.abs(e.deltaY) > Math.abs(e.deltaX))
                                    console.log("showNextPage", window.top),
                                    Ie.postMsg({
                                        type: "pan_nextPage"
                                    }),
                                    Ie.showNextPage();
                                else {
                                    for (var c in Ie.panUpAnimations)
                                        Ie.panUpAnimations[c].rollback();
                                    Ie.panUpAnimations = null
                                }
                            else if (Math.abs(e.deltaY) > Math.abs(e.deltaX))
                                console.log("showPreviousPage", window.top),
                                Ie.postMsg({
                                    type: "pan_prevPage"
                                }),
                                Ie.showPreviousPage();
                            else {
                                for (var c in Ie.panDownAnimations)
                                    Ie.panDownAnimations[c].rollback();
                                Ie.panDownAnimations = null
                            }
                        else if (0 > n && -.1 > n && !t.swipeUpLock)
                            Ie.ensurePages([Ie.currentPageIndex + 1], function() {
                                o.show();
                                for (var e in Ie.panUpAnimations)
                                    Ie.panUpAnimations[e].setValue(-n);
                                for (var e in Ie.panDownAnimations)
                                    Ie.panDownAnimations[e].setValue(0)
                            });
                        else if (n > 0 && n > .1 && !t.swipeDownLock) {
                            a.show();
                            for (var c in Ie.panDownAnimations)
                                Ie.panDownAnimations[c].setValue(n);
                            for (var c in Ie.panUpAnimations)
                                Ie.panUpAnimations[c].setValue(0)
                        }
                    }
                }
            }
            ...
            value: function(e) {
                ...
                var n = window.Config.isAppNormalMode() ? "100% 100%" : "contain"
                  ...
                  , a = void 0
                  , r = void 0;
                e.cropData && !window.Config.isGif(e.picid) && window.Config.isAppNormalMode() ? (r = n,
                o = 0,
                a = 0) : (r = "auto" === e.inw || 0 === e.inw ? n : Ie.scale(e.inw),
                o = Ie.scale(e.intop),
                a = Ie.scale(e.inleft)),
                i.css({
                    position: "absolute",
            ...
            value: function(e) {
                ...
                if (b["default"].isApple()) {
                    ...
                    if ("vertical-lr" === e.writingMode) {
                        var d = parseFloat(Ie.scale(e.ftsize));
                        c = d / 2
                    }
                    if (e.fontbold) {
                        var d = e.ftsize;
                ...
                "text" === e.type) {
                    ...
                    for (v["default"].log(f.toString()); f.hasChildNodes(); )
                        parseInt(f.style.fontSize) && (f.style.fontSize = Ie.scale(parseInt(f.style.fontSize))),
                        f = f.firstChild
                }
                return i
            }
            ...
            value: function(e) {
                ...
                return o && o.hasChildNodes() && (parseInt(o.style.fontSize) && (o.style.fontSize = Ie.scale(parseInt(o.style.fontSize))),
                o = o.firstChild),
                e.url ? (n.attr({
                    href: Ie.url(e.url)
                }),
            ...
            value: function(e) {
                ...
                i.on("click", function() {
                    ...
                    s["default"])("<div></div>")
                      , a = (0,
                    s["default"])('<img src="' + window.Config.getImgOss("images/sending.gif") + '"/>')
                      , r = (0,
                    s["default"])("<p>" + window.Config.language.submiting + "</p>");
                    o.css({
                        position: "fixed",
                        width: "100%",
                        height: "100%",
                    ...
                    if (u && c && (c = !1,
                    r.html(window.Config.language.emptyForm),
                    o.append(r)),
                    c) {
                        for (var f in n)
                            t.formdata[n[f].attr("name")] = n[f].val();
                        o.append(a),
                        o.append(r),
                        s["default"].ajax({
                            type: "post",
            ...
            value: function(e) {
                var t, i = (0,
                s["default"])("<div></div>"), n = (0,
                s["default"])("<div></div>"), o = (0,
                s["default"])("<div></div>");
                i.css({
                    position: "absolute",
            ...
            value: function(e, t) {
                ...
                if ("VUT6I6NZ6H2BPG1G3I54" === e.picid)
                    l.on("touchstart mousedown", function() {
                    ...
                    var u = (0,
                    s["default"])('<div class="scanBar"></div>');
                    u.css({
                        position: "absolute",
                        width: Ie.scale(e.w),
                        height: Ie.scale(e.h),
            ...
            value: function(e, t) {
                ...
                (0,
                s["default"])(e.phoneRemindDom).css({
                    position: "absolute",
                    left: Ie.scale("90"),
                    top: Ie.scale("560"),
                    width: Ie.scale("82"),
                ...
                n.append(a),
                n.append(r),
                n.append(e.phoneInfoDom),
                n.append(e.phoneRemindDom),
                o.append(e.phonecallDom),
                n.append(o),
                window.Config.isAppNormalMode()) {
            ...
            value: function(e, t) {
                ...
                window.Config.isAppNormalMode()) {
                    ...
                    r.on("tap", function() {
                        5 > a && (Ie.audioEffect.src = window.Config.glassBreakVoice,
                        Ie.audioEffect.loop = !1,
                        Ie.audioEffect.play()),
                        (0,
                        s["default"])(o).children(".glass" + a).css({
                            opacity: 1
                        }),
                        ++a > 4 && (e.hasBreak = !0,
            ...
            value: function(e) {
                var t, i, n, o = (0,
                s["default"])('<div class="swiper-container" style="z-index: 0"></div>'), a = (0,
                s["default"])("<ul></ul>");
                return o.css({
                    position: "absolute",
                ...
                e.data.map(function(o) {
                    ...
                    i.append(o.titleText.con),
                    t.append(i)),
                    o.contentText && (n = (0,
                    s["default"])("<div></div>"),
                    o.contentText.opacity ? n.css({
                        position: "absolute",
                        width: "100%",
            ...
            value: function(e, t, i) {
                ...
                if (e.ele = n,
                window.Config.isAppNormalMode()) {
                    var o, a = !1, r = function(e, i) {
                        var n = t.index;
                        e == n ? o = setTimeout(function() {
                            a || e != n || (ge["default"].pauseBg(!1),
                            a = !0)
                        }, 5e3) : (a && (ge["default"].resumeBg(),
                        a = !1),
                        o && (clearTimeout(o),
                        o = void 0))
                    };
            ...
            value: function(e, t, i) {
                ...
                if (window.Config.isAppNormalMode()) {
                    ...
                    var a = function(i, a) {
                        var r = t.index;
                        i !== r || e.hasStart ? a == r && (n.stop(),
                        ge["default"].pauseEffect(),
                        Ie.audioEffect.onended = void 0) : (e.hasStart = !0,
                        n.start(),
                        Ie.audioEffect.src = window.Config.getMusicUrl({
                            id: e.sound,
                            version: 1
                        ...
                        Ie.audioEffect.loop = !1,
                        ge["default"].playEffect(),
                        Ie.audioEffect.onended = function(e) {
                            o()
                        }
                        )
                    };
            ...
            value: function(e, t, i) {
                ...
                return window.Config.isAppNormalMode() && Ie.pageChangeHandlers.push(n.slideCyclicCall.bind(n)),
                n.getDom()
            }
        }, {
            ...
            value: function(e) {
                if (e.rendered || e.rendering) {
                    ...
                    e.bgpic && v["default"].trim(e.bgpic) && "0" !== v["default"].trim(e.bgpic)) {
                        if (e.bgpicCropData && !window.Config.isGif(e.bgpic && window.Config.isAppNormalMode()))
                            (0,
                            s["default"])(e.bgDom).css({
                                position: "absolute",
                                width: 640 * Ie.bgScaleRatio + "px",
                            ...
                            var a = Ie.bgScaleRatio * e.bgpicwidth * (0,
                            s["default"])(e.bgDom).context.naturalHeight / (0,
                            s["default"])(e.bgDom).context.naturalWidth
                              , r = 1;
                            a < document.body.clientHeight && (r = 1 + (document.body.clientHeight - a) / a),
                            (0,
                            s["default"])(e.bgDom).css({
                                position: "absolute",
      ...
      , je = new Ee;
    window.onresize = je.ensureCanvas,
            ...
            value: function(e, t) {
                ...
                s["default"])(t, {
                    ...
                    startCallback: function(e, t) {
                        var i = this.dom.get(0);
                        if (!(i.style.zIndex > 1e3))
                            return i.style.zIndex = parseInt(i.style.zIndex) + 1e3,
                            0
                    }
                }) : "effect-mf" === e ? i = new c["default"](t,{
      ...
      , m = function() {
        ...
        return a(e, [{
            ...
            value: function(e, t, i) {
                ...
                s["default"])("<div></div>")
                  , r = (0,
                s["default"])('<div><img class="avatar" src="' + window.Config.getImgOss("images/user.png") + '" alt="用户头像"></div>')
                  , l = (0,
                s["default"])('<div class="examResult"><div class="exam-result"></div></div>')
                  , c = (0,
                s["default"])('<div class="lazyShow">再玩一次</div>')
                  , u = (0,
                s["default"])('<div class="linkIntro"><a href="http://mp.weixin.qq.com/s?__biz=MjM5ODc3OTM5Mw==&mid=204874023&idx=1&sn=d194c99b10e9dbd1c7757a79293927fc#rd">创建我的测试游戏</a></div>');
                o.css({
                    position: "absolute",
                    width: t(e.w),
            ...
            value: function() {
                ...
                s["default"].ajax({
                    ...
                    success: function(t) {
                        ...
                        window.projectVersion.vip_config.is_vip || e.eleDom.find(".linkIntro").show()
                    },
                    error: function(t) {
                        e.fetchInfoFail(t)
                    }
            ...
            value: function() {
                ...
                d["default"].isWX() && (this.eleDom.find("img").attr("src", o),
                s["default"].ajax({
                    type: "post",
                    data: {
                        result: t,
            ...
            value: function(e) {
                ...
                window.projectVersion.vip_config.is_vip && this.eleDom.find(".linkIntro").show()
            }
        }]),
        e
    }();
    ...
    function() {
        ...
        return a(e, [{
            ...
            value: function(e, t) {
                ...
                this.secLeft.css(a),
                this.dayText = (0,
                s["default"])("<span>天</span>"),
                this.hourText = (0,
                s["default"])("<span>时</span>"),
                this.minText = (0,
                s["default"])("<span>分</span>"),
                this.secText = (0,
                s["default"])("<span>秒</span>"),
                this.dayText.css(o),
                this.hourText.css(o),
                this.minText.css(o),
                this.secText.css(o),
...
, function(e, t, i) {
    ...
    var l = function() {
        function e(t, i, n) {
            o(this, e),
            this.eleDom = (0,
            s["default"])('<div class="eraser"></div>');
            var a = this.eleDom
              , r = i;
            t.forceNoEffect = !0;
            var l = !1;
    ...
    function() {
        ...
        return a(e, [{
            ...
            value: function(e, t, i) {
                function n() {
                    var t = (0,
                    s["default"])(this).parent().data("groupid");
                    1 == e.choiceType ? ((0,
                    s["default"])(".examination-option[data-groupid=" + t + "]").find(".examination-btn").css({
                        borderColor: d.preBorder
                    }).end().find(".examination-selected").css({
                        display: "none"
                    }).end().find(".examination-cover").removeClass("active"),
                    (0,
                    s["default"])(this).addClass("active").parent().find(".examination-btn").css({
                        borderColor: d.aftBorder
                    }).end().find(".examination-selected").css({
                        display: "block"
                    })) : ((0,
                    s["default"])(".examination-option[data-groupid=" + t + "]").find(".examination-btn").css("display", "none").end().find(".examination-cover").removeClass("active"),
                    (0,
                    s["default"])(this).addClass("active").parent().find(".examination-btn").css({
                        display: "-webkit-flex"
                    }));
                    var n = (0,
                    s["default"])(this).data("answer");
                    n == i.examinationResult ? (0,
                    s["default"])(".examination-confirm-html[data-groupid=" + t + "]").eq(0).html("你已测试，查看结果") : (0,
                    s["default"])(".examination-confirm-html[data-groupid=" + t + "]").eq(0).html("确定")
                }
                var o = (0,
                s["default"])('<div class="examination-option" data-groupid=' + e.groupId + "></div>")
                  , a = (0,
                s["default"])("<div></div>")
                  , r = (0,
                s["default"])('<div class="examination-btn"></div>')
                  , l = (0,
                s["default"])("<div data-answer=" + e.answer + ' class="examination-cover"></div>')
                  , c = (0,
                s["default"])('<div class="examination-selected"></div>')
                  , u = (0,
                s["default"])('<span class="icon-checkmark"></span>')
      ...
      , f = function() {
        ...
        return a(e, [{
            ...
            value: function(e, t, i, n) {
                ...
                s["default"])("<div></div>")
                  , c = (0,
                s["default"])('<div class="examination-confirm-html" data-groupid=' + a + ">确定</div>");
                r.css({
                    position: "absolute",
                    width: i(e.w),
                    height: i(e.h),
                ...
                r.on(u, function() {
                    var e = this
                      , i = 0 === (0,
                    s["default"])(".examination-option[data-groupid=" + a + "] .examination-cover.active").length;
                    i || (n.examinationResult = (0,
                    s["default"])(".examination-cover.active").eq(0).data("answer"),
                    setTimeout(function() {
                        t.swipeUpLock = !1,
                        -1 == o.examResultPage ? n.showNextPage() : n.showPage(o.examResultPage),
                        (0,
                        s["default"])(e).find(".examination-confirm-html").eq(0).html("你已测试，查看结果")
                    }, 100))
                }),
                this.eleDom = r
            }
            ...
            value: function() {
                ...
                t.some(function(t, i) {
                    var n = t.content.some(function(t) {
                        return "answer" === t.type ? (e.examResultPage = i,
                        !0) : void 0
                    });
                    return n ? !0 : void 0
                })
    ...
    function() {
        ...
        return a(e, [{
            ...
            value: function(e, t, i, n) {
                ...
                s["default"])("<div></div>")
                  , u = (0,
                s["default"])("<div>" + o.obj.order + "/" + e.qNumber + "</div>")
                  , d = (0,
                s["default"])("<div>" + e.question + "</div>")
                  , f = (0,
                s["default"])("<section></section>");
                ...
                c.appendTo(l),
                this.eleDom = l,
                f.on("click", "p", function() {
                    f.find("p.clicked").removeClass("clicked"),
                    (0,
                    s["default"])(this).addClass("clicked"),
                    i.examinationResult[n.index] = (0,
                    s["default"])(this).data("index") === a,
                    o.renderStyle(),
                    setTimeout(function() {
                        n.swipeUpLock = !1,
                        i.showNextPage()
    ...
    var a = function() {
      ...
      , g = function() {
        ...
        return a(e, [{
            ...
            value: function(e, t) {
                var i, n = this, o = (0,
                s["default"])("<div></div>"), a = (0,
                s["default"])("<div></div>"), r = (0,
                s["default"])("<span>" + n.svg(n.obj.svgXml) + "</span>"), l = (0,
                s["default"])("<span> " + h[n.obj.funcType].text + " </span>");
                r.css({
                    position: "absolute",
    ...
    function() {
        ...
        return a(e, [{
            ...
            value: function(e, t) {
                ...
                s["default"])("<div></div>")
                  , o = (0,
                s["default"])("<div>" + this.obj.text + "</div>");
                i.css({
                    position: "absolute",
                    color: this.obj.ftColor,
                    top: this.scale(this.obj.top),
            ...
            value: function() {
                function e(e) {
                    ...
                    e.map(function(e) {
                        ...
                        s["default"])("<span></span>")
                          , n = (0,
                        s["default"])("<span>刚刚获得了</span>")
                          , o = (0,
                        s["default"])("<span>" + e.nickname + "</span>")
                          , a = (0,
                        s["default"])("<span class='user-sign'>" + e.prize_name + "</span>");
                        t.css({
                            position: "relative",
                            width: "100%",
                            height: h.scale(80),
                ...
                var f = (0,
                s["default"])('<div class="lottery-scratch"></div>');
                f.css({
                    position: "absolute",
                    width: this.scale(this.obj.w),
                    height: this.scale(this.obj.h),
                ...
                s["default"].ajax({
                    ...
                    if (t && 200 == t.code) {
                        ...
                        k && (k.find(".title-num").text(n),
                        k.find(".title-num2").text(o)),
                        g.showWinners && y.length > 0 && e(y)
                    } else
                        console.error(t)
                });
                var k = (0,
                s["default"])("<div>你总共还剩<span class='title-num'>" + v + "</span>次抽奖机会，今天还可以抽<span class='title-num2'>" + w + "</span>次</div>");
                k.css({
                    position: "absolute",
                ...
                s["default"])("<div></div>")
                  , I = (0,
                s["default"])("<span>谢谢参与</span>")
                  , E = (0,
                s["default"])("<canvas></canvas>")
                  , j = (0,
                s["default"])("<div>点击开始</div>");
                x.css({
                    position: "absolute",
                    width: "100%",
                    top: 0,
                ...
                s["default"])("<div></div>")
                  , O = (0,
                s["default"])("<div><div class='out-line'></div><div class='out-name'>中奖用户</div><div class='out-line'></div></div>")
                  , R = (0,
                s["default"])("<div></div>")
                  , U = (0,
                s["default"])("<div></div>")
                  , M = (0,
                s["default"])("<div>当前还没有人中奖，快来试试你的手气吧</div>");
                T.css({
                    position: "absolute",
                    top: this.scale(400),
                    left: 0,
                ...
                s["default"])("<div></div>")
                  , B = (0,
                s["default"])("<div><div class='tip-title'>很遗憾</div><div class='tip-body'>今天没有机会了，下次再来吧</div></div>")
                  , N = (0,
                s["default"])("<div><div class='tip-title'>很遗憾</div><div class='tip-body'>抽奖已过期</div></div>")
                  , F = (0,
                s["default"])("<div><div class='tip-title'>无法抽奖</div><div class='tip-body'>请在微信中打开</div></div>")
                  , H = (0,
                s["default"])("<div><div class='tip-title'>很遗憾</div><div class='tip-body'>没有抽中呢，再接再厉哟</div></div>")
                  , L = (0,
                s["default"])("<div>确认</div>");
                z.css({
                    position: "fixed",
                    width: "100%",
                    height: "100%",
                ...
                s["default"])("<div></div>")
                  , q = (0,
                s["default"])("<div><div class='tip-title'>恭喜您赢得</div></div>")
                  , J = (0,
                s["default"])("<div></div>")
                  , Q = (0,
                s["default"])("<div>请填写您的信息以便我们联系您</div>")
                  , W = (0,
                s["default"])('<input class="lottery-form" type="text" required="required" placeholder="您的姓名" />')
                  , Y = (0,
                s["default"])('<input class="lottery-form" type="text" required="required" placeholder="联系电话" />')
                  , K = (0,
                s["default"])('<input class="lottery-form" type="text" placeholder="备注" />')
                  , G = (0,
                s["default"])("<div>请正确输入信息</div>")
                  , Z = (0,
                s["default"])("<div>提交信息</div>")
                  , X = (0,
                s["default"])("<div><div class='tip-title2'>信息已提交</div><div class='tip-body2'>请耐心等候，我们的客服会跟您联系发奖事宜</div></div>")
                  , _ = (0,
                s["default"])("<div>确认</div>");
                V.css({
                    position: "fixed",
                ...
                j.on(oe, function() {
                    return p["default"].isWX() ? g.deadlineTime < Date.parse(new Date) ? (z.empty(),
                    N.append(L),
                    z.append(N),
                    z.css({
                        "pointer-events": "auto",
                    ...
                    })) : k.find(".title-num2").text() <= 0 ? (z.empty(),
                    B.append(L),
                    z.append(B),
                    z.css({
                        "pointer-events": "auto",
                    ...
                    void L.on(oe, function() {
                        ...
                        if (e && 200 == e.code) {
                            ...
                            if (k && (k.find(".title-num").text(n),
                            k.find(".title-num2").text(a)),
                            I.empty(),
                            1 == i.is_win) {
                                var r = (0,
                                s["default"])("<img src='" + i.prize.pic_url + "' />")
                                  , l = (0,
                                s["default"])("<div>" + i.prize.name + "</div>")
                                  , c = (0,
                                s["default"])("<div></div>");
                                r.css({
                                    height: "5rem",
                ...
                Z.on(oe, function() {
                    ...
                    s["default"].ajax({
                        ...
                        e && 200 == e.code ? r() : (G.text(e.message),
                        G.css({
                            opacity: 1
                        }),
    ...
    var h = function() {
        ...
        return a(e, [{
            ...
            value: function() {
                ...
                var o = (0,
                s["default"])('<div class="lottery-tiger"></div>');
                o.css({
                    position: "absolute",
                    width: this.scale(this.obj.w),
                    height: this.scale(this.obj.h),
                ...
                s["default"].ajax({
                    ...
                    if (t && 200 == t.code) {
                        ...
                        w && (w.find(".title-num").text(n),
                        w.find(".title-num2").text(o)),
                        m.length > 0 && r.showWinners && e(m)
                    } else
                        console.error(t)
                });
                var w = (0,
                s["default"])("<div>你总共还剩<span class='title-num'>" + f + "</span>次抽奖机会，今天还可以抽<span class='title-num2'>" + h + "</span>次</div>");
                w.css({
                    position: "absolute",
                    width: "100%",
                    height: this.scale(35),
                ...
                s["default"])("<div class='tiger-content'></div>")
                  , x = (0,
                s["default"])("<div class='tiger-circular'></div>")
                  , C = (0,
                s["default"])("<div class='tiger-circular'></div>")
                  , P = (0,
                s["default"])("<div class='tiger-circular'></div>")
                  , I = (0,
                s["default"])('<div><div style="margin-top: 10px;">点<br>击<br>开<br>始</div></div>');
                k.css({
                    position: "absolute",
                    top: this.scale(90),
                    left: 0,
                ...
                I.on(B, function() {
                    if (!u) {
                        ...
                        if (r.deadlineTime < Date.parse(new Date))
                            return N.empty(),
                            H.append(q),
                            N.append(H),
                            N.css({
                        ...
                        if (parseInt(w.find(".title-num2").text()) <= 0)
                            return N.empty(),
                            F.append(q),
                            N.append(F),
                            N.css({
                        ...
                        s["default"].ajax({
                            ...
                            if (e && 200 == e.code) {
                                var i = e.data
                                  ...
                                  , a = o > parseInt(n) ? n : o > 0 ? o : 0;
                                if (w && (w.find(".title-num").text(n),
                                w.find(".title-num2").text(a)),
                                1 == i.is_win) {
                                    l = !0,
                                    v ? D += 4 * j : D = D + 4 * j + 3 * E,
                                    v = !0;
                ...
                _.on(B, function() {
                    ...
                    s["default"].ajax({
                        ...
                        e && 200 == e.code ? n() : (X.text(e.message),
                        X.css({
                            opacity: 1
                        }),
                        console.error("setPersonalInfo", e))
        ...
        return a(e, [{
            ...
            value: function() {
                ...
                for (var e = !0, t = 0; t < this.obj.inputs.length; t++) {
                    ...
                    n ? (this.tips[t].empty(),
                    this.requires[t] && this.requires[t].empty(),
                    this.tips[t].append(n),
                    this.inputs[t].css({
            ...
            value: function() {
                ...
                for (var t = 0; t < this.obj.single.length; t++)
                    for (var i = this.obj.single[t].radio, n = 0; n < i.length; n++) {
                        var o = i[n];
                        -1 == this.selectBtn[t] ? (this.btns[t][n].css({
                        ...
                        if (a.radio)
                            for (var c = function(r) {
                                ...
                                l.on(o, function() {
                                    ...
                                    n.selectBtn[t] = r;
                                    for (var e = 0; e < n.btns[t].length; e++)
                                        e != r && n.btns[t][e].css({
                                ...
                                p.append(f.str),
                                l.append(p)
                            }, u = 0; u < a.radio.length; u++)
                                c(u)
                    }, r = 0; r < this.obj.single.length; r++)
                        a(r);
                if (this.obj.inputs)
                    for (var l = function(t) {
                        ...
                        var r = void 0;
                        r = o.textArea ? (0,
                        s["default"])("<textarea></textarea>") : "date" == o.regularType ? (0,
                        s["default"])("<input type=date>") : (0,
                        s["default"])("<input>"),
                        r.css({
                            position: "absolute",
                            outline: "none",
                    ...
                    }, r = 0; r < this.obj.inputs.length; r++)
                        l(r);
                        ...
                        if (!r) {
                            if (n.doValidateInputs() && n.doValidateRadio()) {
                                for (var e = {
                                    event_id: window.Config.getProjectId(),
                                    content: []
                                }, i = 0; i < n.inputs.length; i++)
                                    e.content.push({
                                        module_id: n.obj.inputs[i].moduleId,
                                        answer: n.answers[i]
                                    }),
                                    n.inputs[i].unbind();
                                for (var i = 0; i < n.radios.length; i++)
                                    n.radios[i].unbind();
                                for (var i = 0; n.obj.single && i < n.obj.single.length; i++)
                                    e.content.push({
    ...
    var h = function() {
        ...
        return a(e, [{
            ...
            value: function() {
                ...
                s["default"])("<ul></ul>")
                  , i = (0,
                s["default"])("<div class='un-nav'></div>");
                e.css({
                    position: "absolute",
                    width: this.scale(this.obj.w),
                    height: this.scale(this.obj.h),
                ...
                o.data.map(function(e, o) {
                    var l = (0,
                    s["default"])("<li class='swipe-slide-" + o + "'></li>")
                      , d = (0,
                    s["default"])("<div></div>")
                      , f = (0,
                    s["default"])("<button class='" + (0 === o ? "un-nav-item un-nav-item-current" : "un-nav-item") + "'></button>");
    ...
    function() {
        ...
        return a(e, [{
            ...
            value: function(e, t) {
                ...
                var l = (0,
                s["default"])("<span>" + r.html() + "</span>")
                  , c = (0,
                s["default"])("<span>" + this.obj.text + "</span>");
                l.css({
                    position: "absolute",
...
, function(e, t, i) {
    ...
    function() {
        ...
        return a(e, [{
            ...
            key: "stop",
            value: function() {
                this.timeDom && this.timer && (clearInterval(this.timer),
                this.timer = void 0)
            }
        }, {
            key: "getDom",
    ...
    var a = function() {
      ...
      , w = function() {
        ...
        return a(e, [{
            ...
            value: function() {
                if (c["default"].log("increaseProgress, step progress: " + (this.curStep + 1) + "/" + this.steps),
                this.enabled) {
                    if (0 === this.percent)
                        var e = setInterval(function() {
                            if (this.showPreload) {
                                ...
                                clearInterval(e),
                                d["default"].send("homeEnd"),
                                p["default"].isTemplate() && !p["default"].isRemoveDesignerAd(),
                                setTimeout(function() {
                                    i.callback()
                                }, this.finishDelay)),
      ...
      , h = function() {
        ...
        return a(e, [{
            ...
            value: function(e, t) {
                var i = e[t]
                  , n = i.length;
                return "0" === i[n - 1] && "/" === i[n - 2] && (i = i.slice(0, n - 1) + "64",
                e[t] = i),
                i
            }
        }, {
            ...
            value: function() {
                ...
                if (this.obj.ownInfo && this.obj.shareStr && 1 == this.obj.shareTitle && !this.obj.setShared) {
                    ...
                    if (window.projectVersion.urlParam || (window.projectVersion.urlParam = []),
                    window.projectVersion.urlParam.push("relay_share=true"),
                    c["default"].getUrlParameter("relay_share")) {
                ...
                "link" === this.obj.model_type || "phone" === this.obj.model_type || "interaction" === this.obj.model_type) {
                    ...
                    case "interaction":
                        ...
                        "clicked" === d["default"].getCookie(this._getButtonId()) ? l() : a.click(function() {
                            e.posting || (e.posting = !0,
                            l(),
                            e._setButtonClick().then(function(t) {
                                o.text(t),
                                e.posting = !0
                            })["catch"](function(e) {
                                d["default"].error(e)
                        ...
                        this._getButtonClick().then(function(t) {
                            t.count ? (e.buttonClickCount = t.count,
                            o.text(e.buttonClickCount)) : (e.buttonClickCount = 0,
                            o.text(e.buttonClickCount))
                        }
                    ...
                    var u, f, h, g, m, v, w = (0,
                    s["default"])('<span id="day"></span>'), b = (0,
                    s["default"])('<span id="hour"></span>'), y = (0,
                    s["default"])('<span id="minute"></span>'), k = (0,
                    s["default"])('<span id="second"></span>'), A = 1e3, x = 60 * A, C = 60 * x, P = 24 * C;
                    i.css({
                        position: "absolute",
                        width: "100%",
                        animationDuration: this.obj.speed + "ms",
                    ...
                    j - v > 0) {
                        ...
                        i.append(w),
                        i.append((0,
                        s["default"])('<span class="timeSpace">:</span>')),
                        i.append(b),
                        i.append((0,
                        s["default"])('<span class="timeSpace">:</span>')),
                        i.append(y),
                        ...
                        var S = setInterval(function() {
                            v += 1e3,
                            j - v ? (u = Math.floor((j - v) / P),
                            f = Math.floor((j - v) / C) % 24,
                            h = Math.floor((j - v) / x) % 60,
                            g = Math.floor((j - v) / A) % 60,
                            window.document.getElementById("day").innerHTML = 10 > u ? "0" + u : u,
                            window.document.getElementById("hour").innerHTML = 10 > f ? "0" + f : f,
                            window.document.getElementById("minute").innerHTML = 10 > h ? "0" + h : h,
                            window.document.getElementById("second").innerHTML = 10 > g ? "0" + g : g) : clearInterval(S)
                        }, 1e3)
                    } else
                        i.append("00"),
                        i.append((0,
                        s["default"])('<span class="time-space">:</span>')),
                        i.append("00"),
                        i.append((0,
                        s["default"])('<span class="time-space">:</span>')),
                        i.append("00"),
        ...
        return a(e, [{
            ...
            value: function() {
                ...
                t.svgXml.length && t.svgXml.length > 0) {
                    ...
                    s["default"])("<div></div>");
                    if (a.append(e),
                    a.find("svg").get(0).setAttribute("preserveAspectRatio", "none meet"),
                    console.log("rendershaper", t),
                    "" === t.shapecolor && (t.shapecolor = "rgba(0,0,0,0)"),
                    !t.colorScheme && t.shapecolor)
                        e.find("[fill]").attr({
                            fill: t.shapecolor
                        });
                    else {
    ...
    function() {
        ...
        return a(e, [{
            ...
            value: function(e, t) {
                ...
                s["default"])("<div></div>")
                  , n = (0,
                s["default"])('<iframe frameborder="0" allowfullscreen></iframe>');
                if (0 === e.urlCon.indexOf("http:") || 0 === e.urlCon.indexOf("https:"))
                    this.urlCon = e.urlCon.replace(/\@/g, "");
                else {
            ...
            value: function() {
                ...
                if (this.obj.pic) {
                    var u = this.obj.pic
                      ...
                      , h = void 0
                      , g = void 0;
                    u.cropData && !window.Config.isGif(u.picid) && window.Config.isAppNormalMode() ? (g = f,
                    p = 0,
                    h = 0) : (g = "auto" === u.inw || 0 === u.inw ? f : this.scale(u.inw),
                    p = this.scale(u.intop),
                    h = this.scale(u.inleft)),
                    o = (0,
                    s["default"])("<div></div>"),
                    o.css({
                        position: "absolute",
                ...
                this.obj.btnOption && !function() {
                    ...
                    l = (0,
                    s["default"])('<div class="vote-btn"></div>'),
                    l.css({
                        position: "absolute",
                        top: e.scale(t.top),
                        left: e.scale(t.left),
                    ...
                    o && !function() {
                        ...
                        l.on(i, function() {
                            ...
                            n.allData.hasVoteCnt >= n.allData.vote_per_people && ((0,
                            s["default"])(".vote-btn").css("background-color", "#b8b7b4"),
                            (0,
                            s["default"])(".vote-btn").unbind())
                        })
                    }(),
                    e.btnOptionDom = l
                }(),
    ...
    function() {
        ...
        return a(e, [{
            ...
            value: function() {
                var e = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || function(e) {
                  ...
                  , i = function n(i) {
                    ...
                    1 == t.loop)
                        return void e(n);
                    if (t.preManualValue != t.manualValue && (t.setCss(t.manualValue),
                    t.preManualValue = t.manualValue),
                    void 0 == t.startTime || (new Date).getTime() <= t.startTime + t.options.duration)
                        e(n);
                    else {
                        var o = t.dom.get(0);
                        try {
            ...
            value: function() {
                var e = this.options
                  , t = "";
                if (e.perspective && (t += "perspective(" + e.perspective + "px) "),
                e.position && (t += "translate(" + e.fromPosition[0] + "px, " + e.fromPosition[1] + "px) "),
                e.rotation) {
                    var i = e.fromRotation
                      , n = 0 == i[0] ? 0 == i[1] ? i[2] : i[1] : i[0];
                    t += "rotate3d(" + (0 == i[0] ? 0 : 1) + "," + (0 == i[1] ? 0 : 1) + "," + (0 == i[2] ? 0 : 1) + "," + n + "deg) "
                }
                if (this.css.transform = t,
                void 0 !== e.opacity && (this.css.opacity = e.fromOpacity),
                e.transformOrigin) {
                    var o = "";
            ...
            value: function() {
                var e = this.manualValue
                  , t = this.options
                  , i = "";
                if (t.perspective && (i += "perspective(" + t.perspective + "px) "),
                t.position) {
                    var n = [];
                ...
                return this.each(function() {
                    ...
                    if (!o) {
                        var a = function() {
                            ...
                            r.width = p,
                            r.height = h,
                            r.style.width = d.toString() + "px",
                            r.style.height = f.toString() + "px",
                            s.drawImage(P, -i.cropConfig.x, -i.cropConfig.y, i.cropConfig.w, i.cropConfig.h, 0, 0, p, h),
                            n.remove(),
                            s.globalCompositeOperation = "destination-out",
                            s.strokeStyle = "rgba(255,0,0,255)",
                            s.lineWidth = m,
                            s.lineCap = "round",
                            a.bind("mousedown.eraser", t.mouseDown),
                            a.bind("touchstart.eraser", t.touchStart),
                            a.bind("touchmove.eraser", t.touchMove),
                            a.bind("touchend.eraser", t.touchEnd); C--; )
                                k.push(1);
                            o = {
                                posX: g.left,
                                posY: g.top,
...
, function(e, t, i) {
    ...
    function l(e) {
        if (e.ownInfo && e.shareStr && 1 == e.shareTitle) {
            ...
            if (window.projectVersion.urlParam || (window.projectVersion.urlParam = []),
            window.projectVersion.urlParam.push("relay_share=true"),
            h["default"].getUrlParameter("relay_share")) {
              ...
              , n = function(e) {
                ...
                case "relay":
                    ...
                    t > 0 && h["default"].getCookie(window.Config.wxCookie) && s(n.relayId).then(function(e) {
                        return e && 200 == e.code && (n.canRealy = e.data.can_relay,
                        n.relayed = e.data.already_relay,
                        n.rank = e.data.rank,
                        n.ownInfo = e.data.own_info.ercode ? void 0 : e.data.own_info,
                        n.picSrc = e.data.participators_info || []),
                        l(n),
                        e
                    })
                }
            ...
            function n(r, s) {
                if (s && ("object" == typeof s || "function" == typeof s)) {
                    if (s instanceof o && s.then === o.prototype.then) {
                        for (; 3 === s._81; )
                            s = s._65;
                        return 1 === s._81 ? n(r, s._65) : (2 === s._81 && i(s._65),
...
, function(e, t, i) {
    ...
    function o(e) {
        for (var t = Math.max(e.length - 1, 3), i = [], n = 0; t > n; n++)
            i.push("a" + n);
...
, function(e, t, i) {
    ...
    a.prototype.call = function() {
        try {
            ...
            o.onerror ? o.onerror(e) : (l.push(e),
            c())
        } finally {
            this.task = null,
            s[s.length] = this
      ...
      , b = function() {
        ...
        return a(e, [{
            ...
            value: function() {
                ...
                s["default"])(".ADpage")
                  , a = (0,
                s["default"])('<img style="position:absolute;left:50%;"src="' + window.projectVersion.origin_thumb + '"/>');
                a.css({
                ...
                var r = (0,
                s["default"])('<div style="position:absolute;left:50%;">' + window.projectVersion.title + "</div>");
                r.css({
                ...
                var l = (0,
                s["default"])('<div style="position:absolute;left:50%;"></div>');
                l.css({
