...
,(function(globals,a){
    if("function"== typeof define&&define.cmd){
        define(function(){
            arguments[0]('modal');
            return a.call(arguments[2],globals.jQuery,undefined,'alertbox')
        })
    }else{
        if(globals.alertbox)globals._alertbox=globals.alertbox;
        globals.alertbox=a.call(globals,globals.jQuery,undefined,'alertbox')
    }
})(window,function a(b, c,componentName) {
    function d(a) {
        var b = r[p.locale];
        return b ? b[a] : r.en[a]
    }
