...
function minErr(module) {
  //ngMinErr('cpws',"Can't copy! Making copies of Window or Scope instances is not supported.")
  return function () {
    var code = arguments[0],//cpws
        prefix = '[' + (module ? module + ':' : '') + code + '] ',
        //prefix = [ng:]cpws
        template = arguments[1],
        //template = Can't copy! Making copies of Window or Scope instances is not supported.
...
function inherit(parent, extra) {
  ...
  return extend(fnInstance, extra);
}
