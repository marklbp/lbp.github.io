                    ...
                    <article class="pch-assembly-right">
                        <div v-if="FLAG">
                            ...
                            <el-tree @check-change="selectChange"
                                     :default-checked-keys="subSetParams.roleResourceIdList" :data="privilege"
    ...
    export default {
        ...
        methods: {
            ...
            initData() {
                ...
                api.getRolePrivilege(this.params).then((res) => {
            ...
            subSet() {
                ...
                api.putRolePrivilege(this.subSetParams).then((res) => {
                    if (res && res.code === 200) {
                        this.$message({
                            type: 'success',
                            message: '修改成功!'
