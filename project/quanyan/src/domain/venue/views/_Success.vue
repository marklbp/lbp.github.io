<template lang="html">
    <div class="success">
        <div class="booking-right"></div>
        <div class="booking-text">
            <div class="right-text">申请成功</div>
            <div>我们将尽快完成审核，感谢您的加入！</div>
        </div>
        <div class="complete" @click="compltet()">完成</div>
    </div>
</template>
<script>
...
<style lang="scss">
    ...
    .success{
        ...
        .booking-right{
            ...
            background: url("../assets/booking-right.png")no-repeat 100% 100%;
