(function(factory) {
    ...
    var eventSplitter = /\s+/,
        ...
        eventsApi = function(iteratee, memo, name, callback, opts) {
            var i = 0, names;
    ...
    _.extend(Model.prototype, Events, {
        changed: null,validationError: null,
        idAttribute: "id",
        cidPrefix: "c",
        initialize: function() {},
    ...
    _.extend(Collection.prototype, Events, {
        ...
        sync: function() {
            //Todos.sync("read",Todos,{parse:true,success:fn,error:fn})
            return Backbone.sync.apply(this, arguments)
            //Todos.sync("read",Todos,{parse:true,success:fn,error:fn})
        },
        ...
        fetch: function(options) {
            ...
            wrapError(this, options);
            return this.sync("read", this, options)
            //return Todos.sync("read",Todos,{parse:true,success:fn,error:fn})
        },
    ...
    var collectionMethods = {
        forEach: 3,each: 3,map: 3,collect: 3,
        reduce: 4,foldl: 4,inject: 4,
        reduceRight: 4,foldr: 4,find: 3,
        detect: 3,filter: 3,select: 3,reject: 3,
        every: 3,all: 3,some: 3,any: 3,include: 2,
        contains: 2,invoke: 2,max: 3,min: 3,
        toArray: 1,size: 1,first: 3,head: 3,
        take: 3,initial: 3,rest: 3,tail: 3,
        drop: 3,last: 3,without: 0,difference: 0,
        indexOf: 3,shuffle: 1,lastIndexOf: 3,
    ...
    var View = Backbone.View = function(options) {
            ...
            //_.extend(this,[options,"model", "collection", "el", "id", "attributes", "className", "tagName", "events"])
            //
            this._ensureElement();
            this.initialize.apply(this, arguments)
        },
    ...
    Backbone.sync = function(method, model, options) {
        ...
        //options={parse:true,success:fn,error:fn,emulateHTTP:false,emulateJSON:false}
        ...
        //params={type:"GET",dataType:"json",url:undefined}
        var xhr = options.xhr = Backbone.ajax(_.extend(params, options));
        //params={type:"GET",dataType:"json",url:undefined,parse:true,success:fn,error:fn2,emulateHTTP:false,emulateJSON:false}
        //options={parse:true,success:fn,error:fn2,emulateHTTP:false,emulateJSON:false,xhr:""}
        model.trigger("request", model, xhr, options);
        return xhr
    };
    var methodMap = {"create": "POST","update": "PUT","patch": "PATCH","delete": "DELETE","read": "GET"};
    Backbone.ajax = function() {
        //Backbone.$.ajax({type:"GET",dataType:"json",url:undefined,parse:true,success:fn,error:fn2,emulateHTTP:false,emulateJSON:false})
    ...
    _.extend(Router.prototype, Events, {initialize: function() {
            ...
            //this.routes={"*actions":"defaultRoute"}

            var route, routes = _.keys(this.routes);
            // route,routes=["*actions"]
            while ((route = routes.pop()) != null) {
                this.route(route, this.routes[route])
                //this.route("*actions","defaultRoute")
            }
    ...
    var extend = function(protoProps, staticProps) {
        ...
        _.extend(child, parent, staticProps);   // child继承parent的私有属性
        var Surrogate = function() {
            this.constructor = child            //修改一个对象的构造属性为child
        };
        Surrogate.prototype = parent.prototype; // 拷贝继承parent的原型
        child.prototype = new Surrogate;        // child的原型指向一个对象引用
        if (protoProps) {
            _.extend(child.prototype, protoProps) // 将protoProps的属性拷贝到child的原型中
        }
        child.__super__ = parent.prototype;       //child的超类指向parent的原型
        return child
    };
