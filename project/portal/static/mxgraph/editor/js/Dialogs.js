 ...
 */
window.ColorDialog = function(editorUi, color, apply, cancelFn) {
 ...
 */
window.AboutDialog = function(editorUi) {
  var div = document.createElement('div');
 ...
 */
window.FilenameDialog = function(editorUi, filename, buttonText, fn, label, validateFn, content, helpLink, closeOnBtn, cancelFn, hints) {
 ...
 */
window.TextareaDialog = function(editorUi, title, url, fn, cancelFn, cancelTitle, w, h, addButtons, noHide, noWrap, applyTitle) {
  w = (w != null) ? w : 300;
  h = (h != null) ? h : 120;
 ...
 */
window.EditDiagramDialog = function(editorUi) {
  var div = document.createElement('div');
 ...
 */
window.LinkDialog = function(editorUi, initialValue, btnLabel, fn) {
  var div = document.createElement('div');
 ...
 *
 */
window.OutlineWindow = function(editorUi, x, y, w, h) {
  var graph = editorUi.editor.graph;
 ...
 *
 */
window.LayersWindow = function(editorUi, x, y, w, h) {
  var graph = editorUi.editor.graph;
