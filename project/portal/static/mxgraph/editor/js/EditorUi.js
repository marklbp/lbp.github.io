 ...
 * screen widths <= 640px.
 */
EditorUi.prototype.hsplitPosition = 80/*(screen.width <= 640) ? 118 : 240*/;
...
EditorUi.prototype.refresh = function(sizeDidChange) {
  ...
  if (this.toolbar != null) {
    ...
    this.toolbarContainer.style.top = '56px';
  ...
  this.sidebarContainer.style.top = tmp + 56 + 'px';
  this.sidebarContainer.style.width = effHsplitPosition + 'px';
  // this.sidebarContainer.style.width = '100px';
  ...
  // this.diagramContainer.style.left = '100px';
