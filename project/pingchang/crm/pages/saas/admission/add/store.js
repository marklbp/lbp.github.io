  ...
  baseForm: {
      ...
      ,table: [
        [
            {
                ...
                ,attach: ['groupName', 'lenderId', 'representUserId']
            }
            ,{
               label: '所属集团'
                ,htmlFor: 'groupName'
        ...
        ,[
            {
               label: '所属车厂'
                ,htmlFor: 'belongCarFactory'
                ,type: 'select'
                ,veeControl: true
                ,html: [
                    {
                        name: 'belongCarFactory'
                        ,placeholder: '请选择'
                    }
                ]
            },
      ...
      ,fields: ['parentId','groupName','lenderId',
                'name', 'area', 'belongCity',
                'belongCarFactory', 'hierarchy', 'bussType',
