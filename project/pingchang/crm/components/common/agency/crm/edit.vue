          ...
          <el-row :gutter="24">
            ...
            <el-col :xs="12" :sm="12" :md="8" :lg="8" :xl="6">
              <el-form-item :label="initpage.formName" for="name" :class="{ 'vee-control': true }">
                <el-input v-model="form.name" :maxlength="100" v-validate="'required'" :class="{'input': true, 'is-danger': errors.has('name') }" name="name" type="text" :placeholder="initpage.formName"></el-input>
                <span v-show="errors.has('name')" class="help is-danger">{{ errors.first('name') }}</span>
              </el-form-item>
            </el-col>
            <el-col :xs="12" :sm="12" :md="8" :lg="8" :xl="6">
              <el-form-item :label="initpage.formShortName" for="shortName" :class="{ 'vee-control': true }">
                <el-input v-model="form.shortName" :maxlength="100" v-validate="'required'" :class="{'input': true, 'is-danger': errors.has('shortName') }" name="shortName" type="text" :placeholder="initpage.formShortName"></el-input>
            ...
            <el-col :xs="12" :sm="12" :md="8" :lg="8" :xl="6">
              <el-form-item label="证件号码" for="cardNo" :class="{ 'vee-control': true }">
                <el-input v-model="form.cardNo" :maxlength="64" v-validate="'required|alpha_num'" :class="{'input': true, 'is-danger': errors.has('cardNo') }" name="cardNo" type="text" placeholder="证件号码"></el-input>
            ...
            <el-col :xs="12" :sm="12" :md="8" :lg="8" :xl="6">
              <el-form-item label="营业起始日" for="businessStartDate" :class="{ 'vee-control': true }">
                <el-date-picker :editable="false" v-model="form.businessStartDate" type="date" v-validate="('required|startDate:'+form.businessStartDate+','+form.businessEndDate)" :class="{'input': true, 'is-danger': errors.has('businessStartDate') }" value-format="yyyy-MM-dd" name="businessStartDate" placeholder="营业起始日"></el-date-picker>
            ...
            <el-col :xs="12" :sm="12" :md="8" :lg="8" :xl="6">
              <el-form-item label="电子邮件" for="email" :class="{ 'vee-control': true }">
                <el-input v-model="form.email" :maxlength="32" v-validate="'required|email'" :class="{'input': true, 'is-danger': errors.has('email') }" name="email" type="text" placeholder="电子邮件"></el-input>
            ...
            <el-col :xs="12" :sm="12" :md="8" :lg="8" :xl="6"  v-if="initpage.showTaxerType">
              <el-form-item label="纳税人识别号" for="taxPayerCode" :class="{ 'vee-control': true }">
                <el-input name="taxPayerCode" :maxlength="50"  v-model="form.taxPayerCode" v-validate="'required'" :class="{'input': true, 'is-danger': errors.has('taxPayerCode') }" type="text" placeholder="纳税人识别号"></el-input>
            ...
            <el-col :xs="12" :sm="12" :md="8" :lg="8" :xl="6" v-if="initpage.showNationality">
              <el-form-item label="国籍" for="nationality" :class="{ 'vee-control': true }">
                <el-input name="nationality" :maxlength="64" v-model="form.nationality" v-validate="'required'" :class="{'input': true, 'is-danger': errors.has('nationality') }" type="text" placeholder="国籍"></el-input>
        ...
        <div slot='con'>
          <el-table :fit=true :data="form.contactsList" style="width: 100%" class='pch-table contact-table' stripe>
            ...
            <el-table-column prop="remark" label="备注">
              <template slot-scope="scope">
                <el-input :maxlength="100" v-model="scope.row.remark" placeholder="请输入内容" ></el-input>
              </template>
            </el-table-column>
          ...
          <el-row :gutter="24">
            ...
            <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="8">
              <el-form-item label="姓名" for="realName" :class="{ 'vee-control': true }">
                <el-input v-model="user.realName" readonly v-validate="'required'" class="is-disabled input" :class="{'is-danger': errors.has('realName') }" name="realName" type="text" placeholder="根据左侧手机号点击搜索输入姓名"></el-input>
