        ...
        switch (this.$route.query.agencyType) {
          ...
          case 'store':
            /*if(this.$route.query.itemId){
              ...
              let agency2group2lender = storeEdit.baseForm.table[0];
              let representUserId = storeEdit.baseForm.table[3][0];
          ...
          case 'shop':
            /*if(this.$route.query.itemId){
              ...
              let agency2group2lender = shopEdit.baseForm.table[0];
              let representUserId = shopEdit.baseForm.table[2][2];
          ...
          , transform: (data,dataForm) => {
            ...
            if(data && 'object' == typeof data.storeDetail && data.storeDetail){
              dataForm.baseForm = (agencyType === 'shop') ? {
                ...
                carAmount: data.storeDetail.carAmount,
