...
<script>
  //saas 集团、经销商、公司、门店、展厅 准入申请列表的详情
  import Detail from '@/components/common/agency/saas/agency-detail.vue'
  ...
  export default {
    data() {
      ...
      let noNeedCooperative = /store|shop/.test(this.$route.query.agencyType)
      base.content = detailType && !noNeedCooperative ? {
        lenderName: '所属资方',
    ...
    , methods: {
      ...
      handlerAccountInfo(obj) {
        ...
        let detailType = this.$route.query.detailType;
        let agencyType = this.$route.query.agencyType;
        accountlist = detailType && (agencyType === 'agency' || agencyType === 'company') ? {
          title: '账户信息'
          , module: 'account'
          , content: [
        ...
        accountlist =  (this.$route.query.agencyType === 'shop' || this.$route.query.agencyType === 'store')?{
          title: '账户信息'
          , module: 'account'
          , content: {
            accountType: '账户类型',
